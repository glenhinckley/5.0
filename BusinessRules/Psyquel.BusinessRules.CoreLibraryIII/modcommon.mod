...
'-------------------------------------------------------------------------------
     ...
     MsgBox("Error: " & objErr.Description & vbLf & vbLf & "Error Number: " _
...
'Author: Dave Richkun
'Date: 12/27/1999
'Description: This procedure raises errors to the ing environment.
...
'             object and unloads each form. This routine is typiy ed from
...
'Author: Dave Richkun
'Date: 02/14/2000
'Description: This routine allows only digits to be entered.  The 
'             is typiy placed in the KeyPress event of TextBox controls.
'Returns: Null
'-----------------------------------------------------------------------------------
'Revision History:
'
...
Public Function NumbersOnly(varValue As Object) As Object
'-------------------------------------------------------------------------------
'Author: Dave Richkun
'Date: 04/19/2000
