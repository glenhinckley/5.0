...
Namespace FireRules
    ...
    Public Class Inlinev1
        ...
        Private pipeClientTelemetryPipe As NamedPipeClientStream
        ...
        Protected Overridable Sub Dispose(disposing As Boolean)
            If Not Me.disposedValue Then
                If disposing Then
                    ...
                    pipeClientTelemetryPipe = Nothing
                End If
                                ...
                                Try
                                    ...
                                    If (r = 0) Then
                                        ...
                                        Using mfr As New modFireRulesAddr()
                                            ...
                                            r = 0
                                            _MetricString = mfr.MetricString
        ...
        Private Function SendMetrics(ByVal MSG As String) As Integer
        ...
        Private Function OpenTelemetryPipe() As Integer
            Dim r As Integer = -1

            Try

                pipeClientTelemetryPipe = New NamedPipeClientStream(".", _AppName + "_TelemetryPipe", PipeDirection.Out, PipeOptions.None, TokenImpersonationLevel.Impersonation)
                pipeClientTelemetryPipe.Connect()
        ...
        Private Function SendTelemetry(ByVal MSG As String) As Integer
            Dim r As Integer = -1
