...
Namespace DCSGlobal.Rules
    Public Class modFireRulesAddr_VBS_DLL
        ...
        Public WriteOnly Property DLLURI As String
        ...
        Public WriteOnly Property DLL As Boolean
        ...
        Public Function Go(ByVal PATIENT_AUDIT_TRAIL_ID As Integer) As Integer    '(ByVal Args() As String)
            ...
            If (_RULE_CONTEXT_ID <> 0) Then
                ...
                If _dll = True Then
                    ...
                    Using _vbs As DCSGlobal.Rules.RunViaDLL = New DCSGlobal.Rules.RunViaDLL()

                        _vbs.ConnectionString = _ConnectionString
                        _vbs.RunRules = _RUN_RULES
                        _vbs.PatientAuditTrailID = _PATIENT_AUDIT_TRAIL_ID
                        _vbs.PatHospCode = _PAT_HOSP_CODE
                        _vbs.CfgUspRuleInsertByXmlTank = CfgUspRuleInsertByXmlTank
                        _vbs.CfgUspRuleResultDelete = CfgUspRuleResultDelete
                        _vbs.CommandTimeout = _CommandTimeout
                        _vbs.dll_URI = _dll_URI
                ...
                Else
                    ...
                    Using _vbs As RunViaVBS = New RunViaVBS()
                        ...
                        _vbs.CfgUspRuleResultDelete = CfgUspRuleResultDelete
                        _vbs.CommandTimeout = _CommandTimeout
                        _vbs.dsRulesToFire = _dsRulesToFire
                    End Using
