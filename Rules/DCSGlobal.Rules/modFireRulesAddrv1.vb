...
Namespace FireRules
    ...
    Public Class modFireRulesAddrv1
        ...
        Private _RA_VERSION As String = String.Empty
        Private _RA_SERVER_PORT As String = String.Empty
        Private _RA_PROTOCOL As String = String.Empty
        Private _INSERT_INTO_RA_DEBUG_FLAG As String = String.Empty
        Private _RA_MSG_DELIMITER As String = String.Empty
        ...
        Public Function Go(ByVal iPatAuditTrailId As Integer) As Integer    '(ByVal Args() As String)
            ...
            Try
                ...
                If (strRuleContextID <> "") Then
                    ...
                    iReturnId = getDataByPatientAuditTrailByPatientID(Convert.ToInt32(strPatient_audit_trail_id), strPatHospCode, _
                                                                      strEventDetail, strEvent_type, strHospCode, Convert.ToInt32(_strPid), _
                                                                      Convert.ToInt32(strPatient_id), strMed_record_number, sRunAVSOut, _RUN_RULES) 'SUBBA-20160708 'subba-20160429

                    '--- Start- DCSADDRESS-AesCass---------------subba-042308---------------------------
                    'If (sRunAVSOut = "Y" And bAddrServerLive = True) Then 'subba-082610 'subba-082310

                    If (_Verbose = 1) Then
                        System.Console.Write("Begin Rules for  + " + strPatient_audit_trail_id + " start")
                    End If
                                ...
                                If (sRunAVSOut = "Y") Then
                                    ...
                                    If (_strVerifyAddr = "Y" And _AddressRunMode = "Y") Then 'SUBBA-060508
                                        ...
                                        If ((_AddrTypeFilter.Trim() <> "")) And (_AddrTypeFilter.Split(","c).Length > 0) Then
                                            If (_Verbose = 1) Then
                                                System.Console.Write("Begin address for  + " + strPatient_audit_trail_id + " start")
                                            End If
                                            ...
                                            For Each _AddrType As String In _AddrTypeFilter.Split(CChar(",")) 'order G, P,C 'subba-101813
                                                ...
                                                Select Case (_AddrType)
                                                    ...
                                                    Case "G"
                                                        If (_Verbose = 1) Then
                                                            System.Console.Write("adress  G" + strPatient_audit_trail_id + " start")
                                                        End If
                                                    ...
                                                    Case "P"
                                                        ...
                                                        Using P As New Address
                                                            ...
                                                            Try
                                                                ...
                                                                If (_Verbose = 1) Then
                                                                    System.Console.Write("adress  P" + strPatient_audit_trail_id + " start")
                                                                End If
                                                    ...
                                                    Case "C"
                                                        ...
                                                        Using C As New Address
                                                            ...
                                                            Try
                                                                ...
                                                                If (_Verbose = 1) Then
                                                                    System.Console.Write("adress  C" + strPatient_audit_trail_id + " start")
                                                                End If
                    ...
                    If (_Verbose = 1) Then
                        System.Console.Write("adress  for " + strPatient_audit_trail_id + " end")
                    End If
                    ...
                    If (_Verbose = 1) Then
                        System.Console.Write("All done" + strPatient_audit_trail_id + " end")
                    End If
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Private Function buildXMLRuleInsert(ByVal RULE_ID As Integer, ByVal CONTEXT_ID As Integer, ByVal PATINET_NUMBER As String, _
            ...
            Try
                ...
                Using Con As New SqlConnection(_ConnectionString)
                    ...
                    Using cmd As New SqlCommand(CfgUspRuleInsertDebug, Con)
                        ...
                        cmd.Parameters.Add("@context_id", SqlDbType.Int).Value = CONTEXT_ID
