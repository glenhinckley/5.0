...
namespace DCSGlobal.BusinessRules.CoreLibraryII
{
    public class BuildAssembally : IDisposable 
    {
        ...
        public BuildAssembally(string ipAddress, string AppPath, string AppName, string HostName)
        {
        ...
        public BuildAssembally(string AppName)
        {
            try
            {
                using (MachineID g = new MachineID())
        ...
        {
            _CNameSpace = new CodeNamespace(NameSpace);
        }

        public void CreateImports(string Import)
        {
            _CNameSpace.Imports.Add(new CodeNamespaceImport(Import));
