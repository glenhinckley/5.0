...
namespace DCSGlobal.Rules.DLLBuilder
{
    interface IHelpers
    {
        ...
        private string BuildBuildReturn(string RuleLine)
        {

            string r = string.Empty;


            r = RuleLine.Replace("return", "r = ");
        ...
        private string ReplaceRulePoundSignElements(string RuleLine)
        {
            ...
            if (match.Success)
            {
                ...
                r = RuleLine.Replace(match.Value, _regexValue);
            }
            else
            {
        ...
        private string ReplaceRuleElements(string RuleLine)
        {
            ...
            ////Regex regex_ = new Regex(@"((.*?))");
            ////Match match_ = regex_.Match(RuleLine);
