...
Public Class CHTMLBZ
    ...
    Public Function BuildSchedTable(ByVal lngProviderID As Integer, ByVal dteStartDate As Date, ByVal dteEndDate As Date, Optional ByRef strStartTime As String = "", Optional ByRef strEndTime As String = "", Optional ByVal lngInterval As Integer = 15) As String
        ...
        If IsArray(varSchedObj) Then
            ...
            PopulateSchedObject(lngProviderID, dteStart, dteEnd, varSchedObj, strPStartTime, lngInterval)
    ...
    Public Function BuildDayAtAGlance(ByVal lngUserID As Integer, ByVal dteDate As Date, ByVal lngClinicID As Integer, Optional ByVal strStartTime As String = "7:00 AM", Optional ByVal strEndTime As String = "10:00 PM", Optional ByVal lngInterval As Integer = 15) As String
        ...
        Dim objClinic As New ClinicBz.CUserBz
        Dim rstProviders As New ADODB.Recordset
        ...
        With rstProviders
            ...
            While Not .EOF
                ...
                PopulateDaySchedObject(aryProviders(i, 0), dteDate, i + 1, varSchedObj, strStartTime, lngInterval)
                'UPGRADE_WARNING: Couldn't resolve default property of object i. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                i = i + 1
                .MoveNext()
            End While
    ...
    Private Sub PopulateSchedObject(ByVal lngProviderID As Integer, ByVal dteStartDate As Date, ByVal dteEndDate As Date, ByRef arySched() As udtApptCell, ByVal strApptStartTime As String, ByVal lngInterval As Integer)
        ...
        Dim rstEnc As New ADODB.Recordset
            ...
            If IsArray(aryRecurDates) Then
                For i = 0 To UBound(aryRecurDates)
                    ...
                    If blnException = False Then
                        ...
                        FillCell(rstAppt.Fields("fldApptID").Value, rstAppt.Fields("PatientCount").Value, lngRowSpan, rstAppt.Fields("fldCategoryID").Value, rstAppt.Fields("fldApptTitle").Value, Mid(NNs(rstAppt.Fields("fldNote").Value), 1, 25), lngApptStatusID, lngDayCell, lngTimeCell, blnRecur, arySched)
                    End If
                Next
            End If
SkipIt:
            ...
            While Not .EOF
                ...
                If IsArray(aryRecurDates) Then
                    For i = 0 To UBound(aryRecurDates)
                        ...
                        If blnException = False Then
                            FillCell(.Fields("fldApptID").Value, .Fields("PatientCount").Value, lngRowSpan, .Fields("fldCategoryID").Value, NNs(.Fields("fldApptTitle").Value), Mid(NNs(.Fields("fldNote").Value), 1, 25), .Fields("fldApptStatus").Value, lngDayCell, lngTimeCell, blnRecur, arySched)
                        End If
                    Next
                End If
