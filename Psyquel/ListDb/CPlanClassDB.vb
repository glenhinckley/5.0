...
Public Class CPlanClassDB
    '--------------------------------------------------------------------
    'Class Name: CPlanClassDB
    'Date: 01/12/2000
    'Author: Eric Pena
    'Description:  MTS object designed to host methods associated with
    '              data affecting the tblPlanClassification table.
    '--------------------------------------------------------------------
    ' Revision History:                                                 '
    ...
    Private Const CLASS_NAME As String = "CPlanClassDB"
    Private Const TABLE_NAME As String = "tblPlanClassification"
    ...
    Public Function Fetch(Optional ByVal blnIncludeDisabled As Boolean = False, Optional ByVal strWhere As String = "", Optional ByVal strOrderBy As String = "") As ADODB.Recordset
        ...
        strSQL = "SELECT "
        strSQL = strSQL & "fldPlanClassID, "
        strSQL = strSQL & "fldPlanClass, "
    ...
    Public Sub Update(ByVal lngID As Integer, ByVal strDescription As String)
        ...
        'Date: 01/12/2000
        'Author: Eric Pena
        'Description:  Updates a row into the tblPlanClassification table utilizing
        '              a stored procedure.
    ...
    Public Sub Deleted(ByVal blnDeleted As Boolean, ByVal lngID As Integer)
        ...
        strSQL = strSQL & "WHERE "
        strSQL = strSQL & "fldPlanClassID = " & lngID
    ...
    Public Function Exists(ByVal strDescription As String) As Boolean
        ...
        'Date: 01/12/2000
        'Author: Eric Pena
        'Description:  Determines if a Plan Classification record identical to the
        ...
        strSQL = strSQL & TABLE_NAME
        strSQL = strSQL & " WHERE "
        strSQL = strSQL & " fldPlanClass = '" & strDescription & "' "
