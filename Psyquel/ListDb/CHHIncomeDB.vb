...
Public Class CHHIncomeDB
    '--------------------------------------------------------------------
    'Class Name: CHHIncomeDB
    'Date: 11/04/1999
    'Author: Dave Richkun
    'Description:  MTS object designed to host methods associated with
    '              data affecting the tblHHIncome table.
    '--------------------------------------------------------------------
    ' Revision History:                                                 '
    ...
    Private Const CLASS_NAME As String = "CHHIncomeDB"
    Private Const TABLE_NAME As String = "tblHHIncome"
    ...
    Public Function Insert(ByVal strDescription As String) As Integer
        ...
        '              a stored procedure.
        'Parameters: strDescription - The description of the HHIncome status
    ...
    Public Sub Update(ByVal lngID As Integer, ByVal strDescription As String)
        ...
        'Date: 11/04/1999
        'Author: Dave Richkun
        'Description:  Updates a row into the tblHHIncome table utilizing
        '              a stored procedure.
        'Parameters:  lngID - ID of the row in the table whose value will be
        '               updated.
        '             strDescription - The HHIncome status description
    ...
    Public Sub Deleted(ByVal blnDeleted As Boolean, ByVal lngID As Integer)
        ...
        'Date: 12/30/1999
        'Author: Dave Richkun
        'Description:  Flags a row in the tblHHIncome table marking the row as
        ...
        strSQL = strSQL & "WHERE "
        strSQL = strSQL & "fldHHIncomeID = " & lngID
    ...
    Public Function Exists(ByVal strDescription As String) As Boolean
        ...
        'Date: 01/05/2000
        'Author: Dave Richkun
        'Description:  Determines if a HHIncome status record identical to the
        '              strDescription parameter already exists in the table.
        'Parameters: strDescription - HHIncome status record to be checked
        ...
        strSQL = strSQL & TABLE_NAME
        strSQL = strSQL & " WHERE "
        strSQL = strSQL & " fldHHIncomeDesc = '" & strDescription & "' "
