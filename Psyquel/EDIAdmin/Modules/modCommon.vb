Module modCommon
    ...
    Public Sub RaiseError(ByVal objErr As Object, Optional ByVal lngSQLErrorNum As Long = 0, Optional ByVal strSource As String = "", Optional ByVal strDescription As String = "")
        '-------------------------------------------------------------------------------
        'Author: Dave Richkun
        'Date: 12/27/1999
...
ErrTrap:
    ...
    Public Sub FriendlyNumberBox(Optional ByVal intStart As Integer = 0)
        '-----------------------------------------------------------------------------------
