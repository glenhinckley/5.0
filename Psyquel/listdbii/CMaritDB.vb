...
Public Class CMaritDB
    '--------------------------------------------------------------------
    'Class Name: CMaritDB
    'Date: 01/12/2000
    'Author: Eric Pena
    'Description:  MTS object designed to host methods associated with
    '              data affecting the tblMaritalStatus table.
    '--------------------------------------------------------------------
    ' Revision History:                                                 '
    ...
    Private Const CLASS_NAME As String = "CMaritDB"
    Private Const TABLE_NAME As String = "tblMaritalStatus"
    ...
    Public Function Fetch(Optional ByVal blnIncludeDisabled As Boolean = False, Optional ByVal strWhere As String = "", Optional ByVal strOrderBy As String = "") As ADODB.Recordset
        ...
        strSQL = "SELECT "
        strSQL = strSQL & "fldMaritalStatusID, "
        strSQL = strSQL & "fldMaritalStatus, "
    ...
    Public Sub Update(ByVal lngID As Integer, ByVal strDescription As String)
        ...
        'Date: 01/12/2000
        'Author: Eric Pena
        'Description:  Updates a row into the tblMaritalStatus table utilizing
        '              a stored procedure.
    ...
    Public Sub Deleted(ByVal blnDeleted As Boolean, ByVal lngID As Integer)
        ...
        strSQL = strSQL & "WHERE "
        strSQL = strSQL & "fldMaritalStatusID = " & lngID
    ...
    Public Function Exists(ByVal strDescription As String) As Boolean
        ...
        'Date: 01/12/2000
        'Author: Eric Pena
        'Description:  Determines if a Marital status record identical to the
        ...
        strSQL = strSQL & TABLE_NAME
        strSQL = strSQL & " WHERE "
        strSQL = strSQL & " fldMaritalStatus = '" & strDescription & "' "
