...
Namespace DCSGlobal.EDI
    ...
    Public Class EDI_5010_VALIDATE
        ...
        Public Function byList(ByVal EDIList As List(Of String), ByVal FileID As Integer) As Int32
            Dim r As Integer = -1
            r = Validate(EDIList)
        ...
        Public Function byList(ByVal EDIList As List(Of String)) As Int32

            Return Validate(EDIList)
        ...
        Private Function Validate(ByVal EDIList As List(Of String)) As Integer
            ...
            Dim NM101 As String = String.Empty
            ...
            Try
                ...
                For Each line As String In EDIList
                    ...
                    If _RowRecordType = "NM1" Then
                        ...
                        NM101 = ss.ParseDemlimtedStringEDI(_CurrentRowData, _DataElementSeparator, 2)

                        If (NM101 = "1p" Or NM101 = "80" Or NM101 = "FA") Then
                            _NPI = ss.ParseDemlimtedStringEDI(_CurrentRowData, _DataElementSeparator, 10)
                        End If

                        If (NM101 = "PR") Then
                            _CSN = ss.ParseDemlimtedStringEDI(_CurrentRowData, _DataElementSeparator, 10)
                        End If
