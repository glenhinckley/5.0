...
Namespace DCSGlobal.EDI
    ...
    Public Class EDI837Tables
        ...
        Public Sub BuildTables()
            ...
            '    GE.Columns.Add("BATCH_ID", GetType(Integer))
            '    GE.Columns.Add("ISA_ID", GetType(Integer))
            ...
            'INHERTED FROM COMMON TALBES ADD ANY SPIFIC ROWS HERE
            ...
            '    AAA.Columns.Add("837_CLM_GUID", GetType(Guid))
            '    AAA.Columns.Add("837_LX_GUID", GetType(Guid))
            ...
            '    N1.Columns.Add("837_CLM_GUID", GetType(Guid))
            '    N1.Columns.Add("837_LX_GUID", GetType(Guid))
            ...
            '    TRN.Columns.Add("837_CLM_GUID", GetType(Guid))
            '    TRN.Columns.Add("837_LX_GUID", GetType(Guid))
            ...
            '    CN1.Columns.Add("ROW_ID", GetType(Integer)).AutoIncrement = True

            '    CN1.Columns.Add("DOCUMENT_ID", GetType(Integer))
            '    CN1.Columns.Add("FILE_ID", GetType(Integer))
            '    'CN1.Columns.Add("BATCH_ID", GetType(Integer))
            '    CN1.Columns.Add("ISA_ID", GetType(Integer))
            '    CN1.Columns.Add("GS_ID", GetType(Integer))
            '    CN1.Columns.Add("ST_ID", GetType(Integer))
            '    CN1.Columns.Add("HIPAA_ISA_GUID", GetType(Guid))
            '    CN1.Columns.Add("HIPAA_GS_GUID", GetType(Guid))
            '    CN1.Columns.Add("HIPAA_ST_GUID", GetType(Guid))
            '    CN1.Columns.Add("HIPAA_HL_20_GUID", GetType(Guid))
            '    CN1.Columns.Add("HIPAA_HL_21_GUID", GetType(Guid))
            '    CN1.Columns.Add("HIPAA_HL_22_GUID", GetType(Guid))
            '    CN1.Columns.Add("HIPAA_HL_23_GUID", GetType(Guid))
            '    CN1.Columns.Add("HIPAA_HL_24_GUID", GetType(Guid))
            '    CN1.Columns.Add("837_CLM_GUID", GetType(Guid))
            '    CN1.Columns.Add("837_LX_GUID", GetType(Guid))
            '    CN1.Columns.Add("HL01", GetType(Integer))
            '    CN1.Columns.Add("HL02", GetType(Integer))
            '    CN1.Columns.Add("HL03", GetType(Integer))
            '    CN1.Columns.Add("HL04", GetType(Integer))
            '    CN1.Columns.Add("CN101", GetType(String))
            '    CN1.Columns.Add("CN102", GetType(String))
            '    CN1.Columns.Add("CN103", GetType(String))
            '    CN1.Columns.Add("CN104", GetType(String))
            '    CN1.Columns.Add("CN105", GetType(String))
            '    CN1.Columns.Add("CN106", GetType(String))
            '    CN1.Columns.Add("ROW_NUMBER", GetType(Integer))
            '    CN1.Columns.Add("LOOP_LEVEL_MAJOR", GetType(Integer))
            '    CN1.Columns.Add("LOOP_LEVEL_MINOR", GetType(Integer))
            '    CN1.Columns.Add("LOOP_LEVEL_SUBFIX", GetType(String))
            ...
            'Try
            '    CR2.Columns.Add("ROW_ID", GetType(Integer)).AutoIncrement = True
            '    CR2.Columns.Add("DOCUMENT_ID", GetType(Integer))
            '    CR2.Columns.Add("FILE_ID", GetType(Integer))
            '    'CR2.Columns.Add("BATCH_ID", GetType(Integer))
            '    CR2.Columns.Add("ISA_ID", GetType(Integer))
            '    CR2.Columns.Add("GS_ID", GetType(Integer))
            '    CR2.Columns.Add("ST_ID", GetType(Integer))
            '    CR2.Columns.Add("HIPAA_ISA_GUID", GetType(Guid))
            '    CR2.Columns.Add("HIPAA_GS_GUID", GetType(Guid))
            '    CR2.Columns.Add("HIPAA_ST_GUID", GetType(Guid))
            '    CR2.Columns.Add("HIPAA_HL_20_GUID", GetType(Guid))
            '    CR2.Columns.Add("HIPAA_HL_21_GUID", GetType(Guid))
            '    CR2.Columns.Add("HIPAA_HL_22_GUID", GetType(Guid))
            '    CR2.Columns.Add("HIPAA_HL_23_GUID", GetType(Guid))
            '    CR2.Columns.Add("HIPAA_HL_24_GUID", GetType(Guid))
            '    CR2.Columns.Add("837_CLM_GUID", GetType(Guid))
            '    CR2.Columns.Add("837_LX_GUID", GetType(Guid))
            '    CR2.Columns.Add("HL01", GetType(Integer))
            '    CR2.Columns.Add("HL02", GetType(Integer))
            '    CR2.Columns.Add("HL03", GetType(Integer))
            '    CR2.Columns.Add("HL04", GetType(Integer))
            '    CR2.Columns.Add("CR201", GetType(String))
            '    CR2.Columns.Add("CR202", GetType(String))
            '    CR2.Columns.Add("CR203", GetType(String))
            '    CR2.Columns.Add("CR204", GetType(String))
            '    CR2.Columns.Add("CR205", GetType(String))
            '    CR2.Columns.Add("CR206", GetType(String))
            '    CR2.Columns.Add("CR207", GetType(String))
            '    CR2.Columns.Add("CR208", GetType(String))
            '    CR2.Columns.Add("CR209", GetType(String))
            '    CR2.Columns.Add("CR210", GetType(String))
            '    CR2.Columns.Add("CR211", GetType(String))
            '    CR2.Columns.Add("CR212", GetType(String))
            '    CR2.Columns.Add("ROW_NUMBER", GetType(Integer))
            '    CR2.Columns.Add("LOOP_LEVEL_MAJOR", GetType(Integer))
            '    CR2.Columns.Add("LOOP_LEVEL_MINOR", GetType(Integer))
            '    CR2.Columns.Add("LOOP_LEVEL_SUBFIX", GetType(String))
            'Catch ex As Exception
            ...
            'Try
            '    CTP.Columns.Add("ROW_ID", GetType(Integer)).AutoIncrement = True

            '    CTP.Columns.Add("DOCUMENT_ID", GetType(Integer))
            '    CTP.Columns.Add("FILE_ID", GetType(Integer))
            '    'CTP.Columns.Add("BATCH_ID", GetType(Integer))
            '    CTP.Columns.Add("ISA_ID", GetType(Integer))
            '    CTP.Columns.Add("GS_ID", GetType(Integer))
            '    CTP.Columns.Add("ST_ID", GetType(Integer))
            '    CTP.Columns.Add("HIPAA_ISA_GUID", GetType(Guid))
            '    CTP.Columns.Add("HIPAA_GS_GUID", GetType(Guid))
            '    CTP.Columns.Add("HIPAA_ST_GUID", GetType(Guid))
            '    CTP.Columns.Add("HIPAA_HL_20_GUID", GetType(Guid))
            '    CTP.Columns.Add("HIPAA_HL_21_GUID", GetType(Guid))
            '    CTP.Columns.Add("HIPAA_HL_22_GUID", GetType(Guid))
            '    CTP.Columns.Add("HIPAA_HL_23_GUID", GetType(Guid))
            '    CTP.Columns.Add("HIPAA_HL_24_GUID", GetType(Guid))
            '    CTP.Columns.Add("837_CLM_GUID", GetType(Guid))
            '    CTP.Columns.Add("837_LX_GUID", GetType(Guid))
            '    CTP.Columns.Add("HL01", GetType(Integer))
            '    CTP.Columns.Add("HL02", GetType(Integer))
            '    CTP.Columns.Add("HL03", GetType(Integer))
            '    CTP.Columns.Add("HL04", GetType(Integer))
            '    CTP.Columns.Add("CTP01", GetType(String))
            '    CTP.Columns.Add("CTP02", GetType(String))
            '    CTP.Columns.Add("CTP03", GetType(String))
            '    CTP.Columns.Add("CTP04", GetType(String))
            '    CTP.Columns.Add("CTP05", GetType(String))
            '    CTP.Columns.Add("CTP05_01", GetType(String))
            '    CTP.Columns.Add("CTP05_02", GetType(String))
            '    CTP.Columns.Add("CTP05_03", GetType(String))
            '    CTP.Columns.Add("CTP05_04", GetType(String))
            '    CTP.Columns.Add("CTP05_05", GetType(String))
            '    CTP.Columns.Add("CTP05_06", GetType(String))
            '    CTP.Columns.Add("CTP05_07", GetType(String))
            '    CTP.Columns.Add("CTP05_08", GetType(String))
            '    CTP.Columns.Add("CTP05_09", GetType(String))
            '    CTP.Columns.Add("CTP05_10", GetType(String))
            '    CTP.Columns.Add("CTP05_11", GetType(String))
            '    CTP.Columns.Add("CTP05_12", GetType(String))
            '    CTP.Columns.Add("CTP05_13", GetType(String))
            '    CTP.Columns.Add("CTP05_14", GetType(String))
            '    CTP.Columns.Add("CTP05_15", GetType(String))
            '    CTP.Columns.Add("CTP06", GetType(String))
            '    CTP.Columns.Add("CTP07", GetType(String))
            '    CTP.Columns.Add("CTP08", GetType(String))
            '    CTP.Columns.Add("CTP09", GetType(String))
            '    CTP.Columns.Add("CTP10", GetType(String))
            '    CTP.Columns.Add("CTP11", GetType(String))
            '    CTP.Columns.Add("ROW_NUMBER", GetType(Integer))
            '    CTP.Columns.Add("LOOP_LEVEL_MAJOR", GetType(Integer))
            '    CTP.Columns.Add("LOOP_LEVEL_MINOR", GetType(Integer))
            '    CTP.Columns.Add("LOOP_LEVEL_SUBFIX", GetType(String))
            'Catch ex As Exception
            ...
            '    DTM.Columns.Add("HIPAA_HL_20_GUID", GetType(Guid))
            '    DTM.Columns.Add("HIPAA_HL_21_GUID", GetType(Guid))
            '    DTM.Columns.Add("HIPAA_HL_22_GUID", GetType(Guid))
            '    DTM.Columns.Add("HIPAA_HL_23_GUID", GetType(Guid))
            '    DTM.Columns.Add("HIPAA_HL_24_GUID", GetType(Guid))
            '    DTM.Columns.Add("837_CLM_GUID", GetType(Guid))
            '    DTM.Columns.Add("837_LX_GUID", GetType(Guid))
            '    DTM.Columns.Add("HL01", GetType(Integer))
            '    DTM.Columns.Add("HL02", GetType(Integer))
            '    DTM.Columns.Add("HL03", GetType(Integer))
            '    DTM.Columns.Add("HL04", GetType(Integer))
            ...
            'Try
            '    HCP.Columns.Add("ROW_ID", GetType(Integer)).AutoIncrement = True
            '    HCP.Columns.Add("FILE_ID", GetType(Integer))
            '    HCP.Columns.Add("GS_ID", GetType(Integer))
            '    HCP.Columns.Add("ST_ID", GetType(Integer))
            '    HCP.Columns.Add("HIPAA_ISA_GUID", GetType(Guid))
            '    HCP.Columns.Add("HIPAA_GS_GUID", GetType(Guid))
            '    HCP.Columns.Add("HIPAA_ST_GUID", GetType(Guid))
            '    HCP.Columns.Add("HIPAA_HL_20_GUID", GetType(Guid))
            '    HCP.Columns.Add("HIPAA_HL_21_GUID", GetType(Guid))
            '    HCP.Columns.Add("HIPAA_HL_22_GUID", GetType(Guid))
            '    HCP.Columns.Add("HIPAA_HL_23_GUID", GetType(Guid))
            '    HCP.Columns.Add("HIPAA_HL_24_GUID", GetType(Guid))
            '    HCP.Columns.Add("HL01", GetType(Integer))
            '    HCP.Columns.Add("HL02", GetType(Integer))
            '    HCP.Columns.Add("HL03", GetType(Integer))
            '    HCP.Columns.Add("HL04", GetType(Integer))
            '    HCP.Columns.Add("HCP01", GetType(String))
            '    HCP.Columns.Add("HCP02", GetType(String))
            '    HCP.Columns.Add("HCP03", GetType(String))
            '    HCP.Columns.Add("HCP04", GetType(String))
            '    HCP.Columns.Add("HCP05", GetType(String))
            '    HCP.Columns.Add("HCP06", GetType(String))
            '    HCP.Columns.Add("HCP07", GetType(String))
            '    HCP.Columns.Add("HCP08", GetType(String))
            '    HCP.Columns.Add("HCP09", GetType(String))
            '    HCP.Columns.Add("HCP10", GetType(String))
            '    HCP.Columns.Add("HCP11", GetType(String))
            '    HCP.Columns.Add("HCP12", GetType(String))
            '    HCP.Columns.Add("HCP13", GetType(String))
            '    HCP.Columns.Add("HCP14", GetType(String))
            '    HCP.Columns.Add("HCP15", GetType(String))
            '    HCP.Columns.Add("ROW_NUMBER", GetType(Integer))
