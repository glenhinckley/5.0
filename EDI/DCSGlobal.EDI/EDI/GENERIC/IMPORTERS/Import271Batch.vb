...
Namespace DCSGlobal.EDI
    ...
    Public Class Import271Batch
        ...
        Public WriteOnly Property MaxRowCount As Double

            Set(value As Double)
                oD._MaxRowCount = value
        ...
        Public Function Import() As Integer
            ...
            Catch ex As Exception
                ...
                log.ExceptionDetails("DCSGlobal.EDI.Import271Batch", ex)
            ...
            For idx_EDI271 = 1 To oD.ediTildeCount
                ...
                If oD._BatchID = 0 Then
                    ...
                    log.ExceptionDetails("DCSGlobal.EDI.Import271Batch", "BatchID = 0 err -1")
                ...
                If idx_EDI271 = oD._MaxRowCount Then

                    log.ExceptionDetails("DCSGlobal.EDI.Import271Batch", "idx_EDI271 exceeded index count execed " + idx_EDI271.ToString + "  err -2")
                    rr = -2
                    Return rr
                    Exit Function
                End If
                ...
                oD.ediRowData = objss.ParseDemlimtedStringEDI(oD.edi, oD.SegmentTerminator, Convert.ToInt32(idx_EDI271))
            ...
            For Each row As DataRow In EDI_271.Rows
                oD.CurrentRowData = Convert.ToString(row.Item("ROW_DATA"))
                oD.ROW_RECORD_TYPE = Convert.ToString(row.Item("ROW_RECORD_TYPE"))
                ...
                If oD.ROW_RECORD_TYPE = "BHT" Then
                    ...
                    Try
                        oD._BatchID = Convert.ToInt64(objss.ParseDemlimtedStringEDI(oD.BHT03, "-", 1))
                    Catch ex As Exception
                        log.ExceptionDetails("DCSGlobal.EDI.Import271Batch", ex)
                    ...
                    ISA.Rows.Add(ISARow)
                    oD.ISA_ROW_ID = CInt(row.Item("ROW_ID"))
                    ...
                    ST.Rows.Add(STRow)
                    oD.ST_ROW_ID = CInt(row.Item("ROW_ID"))
                ...
                If oD.ROW_RECORD_TYPE = "EB" Then
                    ...
                    'SET @EBGroupById = (@BatchID  + @CuurrentRow)   
                    ...
                    ' 
                    ' '********'  
                    ' 'here we get EB03 to check and see it has ^ Also we SET store the Current Row in the EBLastRow so when we come to and EE we stil have the EB data'  
                    ' 'EB @CuurrentRow' + CONVERT(varchar(max) , @CuurrentRow)          
                    ' 'EBROwData'  

                    ' '********'  
                    ' 'this is the eb03 row data' + @EBEB03RowData  
                    ' '*********'  


                    'If oD.EBEB03RowData = vbNull Or oD.EBEB03RowData = vbNullString Then
                    '    '                                BEGIN()
                    '    oD.EBCarrotFlag = 0
                    ...
                    '    '  '********'  
                    '    '  'This will happen IF the EB03 data block is empty or null sood.EBCarrotFlag 0'   
                    '    '  'cause some of the other stuff blows u on nulls and does not '  
                    '    '  '*********'  
                    '    '  ''  
                    '    ' 
                    'End If
                    ...
                    If oD.EBCarrotFlag = 0 Then
                        ...
                        ' ''20:
                        ' ''21:
                        'EBRow("EB01") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 2)
                        'EBRow("EB02") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 3)
                        ''EBRow("EB03") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 4)
                        ''EBRow("EB04") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 5)
                        'If (objss.ParseDemlimtedString(oD.CurrentRowData, oD.RowDataDelimiter, 4) <> "") Then EBRow("EB03") = DBNull.Value Else EBRow("EB03") = objss.ParseDemlimtedString(oD.CurrentRowData, oD.RowDataDelimiter, 4)
                        'If (objss.ParseDemlimtedString(oD.CurrentRowData, oD.RowDataDelimiter, 5) <> "") Then EBRow("EB04") = DBNull.Value Else EBRow("EB04") = objss.ParseDemlimtedString(oD.CurrentRowData, oD.RowDataDelimiter, 5)
                        'If (objss.ParseDemlimtedString(oD.CurrentRowData, oD.RowDataDelimiter, 6) <> "") Then
                        '    EBRow("EB05") = objss.ParseDemlimtedString(oD.CurrentRowData, oD.RowDataDelimiter, 6)
                        'Else

                        '    EBRow("EB05") = DBNull.Value
                        'End If

                        ''EBRow("EB05") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 6)
                        'EBRow("EB06") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 7)
                        'EBRow("EB07") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 8)
                        'EBRow("EB08") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 9)
                        'EBRow("EB09") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 10)
                        'EBRow("EB10") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 11)
                        'EBRow("EB11") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 12)
                        'EBRow("EB12") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 13)
                        'EBRow("EB13") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 14)
                        'EBRow("EB13_1") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 15)
                        'EBRow("EB13_2") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 16)
                        'EBRow("EB13_3") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 17)
                        'EBRow("EB13_4") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 18)
                        'EBRow("EB13_5") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 19)
                        'EBRow("EB13_6") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 20)
                        'EBRow("EB13_7") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 21)
                ...
                If oD.ROW_RECORD_TYPE = "HSD" Then
                    ...
                    If oD.EBCarrotFlag = 1 Then
                        ...
                        'CHSDRow("HSD01") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 2)
                        'CHSDRow("HSD02") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 3)
                        'CHSDRow("HSD03") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 4)
                        'CHSDRow("HSD04") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 5)
                        'CHSDRow("HSD05") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 6)
                        'CHSDRow("HSD06") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 7)
                        'CHSDRow("HSD07") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 8)
                        'CHSDRow("HSD08") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 9)
                ...
                If oD.ROW_RECORD_TYPE = "HL" Then
                    ...
                    If oD.EBCarrotFlag = 1 Then
                        ...
                        'CHLRow("HL01") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 2)
                        'CHLRow("HL02") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 3)
                        'CHLRow("HL03") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 4)
                        'CHLRow("HL04") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 5)
                ...
                If oD.ROW_RECORD_TYPE = "III" Then
                    ...
                    If oD.EBCarrotFlag = 1 Then
                        ...
                        'CIIIRow("III01") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 2)
                        'CIIIRow("III02") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 3)
                        'CIIIRow("III03") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 4)
                        'CIIIRow("III04") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 5)
                        'CIIIRow("III05") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 6)
                        'CIIIRow("III06") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 7)
                        'CIIIRow("III07") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 8)
                        'CIIIRow("III08") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 9)
                ...
                If oD.ROW_RECORD_TYPE = "N3" Then
                    ...
                    If oD.EBCarrotFlag = 1 Then
                        ...
                        'CN3Row("N301") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 2)
                        'CN3Row("N302") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 3)
                ...
                If oD.ROW_RECORD_TYPE = "N4" Then
                    ...
                    If oD.EBCarrotFlag = 1 Then
                        ...
                        'CN4Row("N401") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 2)
                        'CN4Row("N402") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 3)
                        'CN4Row("N403") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 4)
                        'CN4Row("N404") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 5)
                        'CN4Row("N405") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 6)
                        'CN4Row("N406") = objss.ParseDemlimtedStringEDI(oD.CurrentRowData, oD.RowDataDelimiter, 7)
        ...
        '        Dim retValParam As New SqlParameter("@totalweight", Data.SqlDbType.Decimal)
        'retValParam.Direction = Data.ParameterDirection.Output
        'cmd.Parameters.Add(retValParam)

        'cnn.Open()
        '        Dim reader As SqlDataReader = cmd.ExecuteReader()
        'Profile.RO_ORDER_WEIGHT = retValParam.Value
        'Me.TextBox1.Text = Profile.RO_ORDER_WEIGHT.ToString
        ...
        Private Function Comit() As Integer
            ...
            Catch ex As Exception
                ...
                log.ExceptionDetails("DCSGlobal.EDI.Import_271 " + Me.ToString, ex)
