...
Namespace DCSGlobal.EDI
    ...
    Public Class EDI_5010_276_00510X212_TABLES
        ...
        Public CLS_AMT As New DataTable
        ...
        Public DMG As New DataTable
        Public CLS_DMG As New DataTable
        Public CSR_DMG As New DataTable


        Public DTP As New DataTable
        Public CLS_DTP As New DataTable
        Public CSR_DTP As New DataTable
        ...
        Public CSR_NM1 As New DataTable
        ...
        Public Sub BuildTables()
            ...
            Try
                ...
                AMT.Columns.Add("HIPAA_HL_19_GUID", GetType(Guid))
                ...
                AMT.Columns.Add("276_ISL_GUID", GetType(Guid))
                AMT.Columns.Add("276_IRL_GUID", GetType(Guid))
                AMT.Columns.Add("276_SPL_GUID", GetType(Guid))
                AMT.Columns.Add("276_CLS_GUID", GetType(Guid))
                AMT.Columns.Add("276_SLS_GUID", GetType(Guid))
            ...
            Try
                CLS_AMT.Columns.Add("ROW_ID", GetType(Integer)).AutoIncrement = True
                CLS_AMT.Columns.Add("DOCUMENT_ID", GetType(Integer))
                CLS_AMT.Columns.Add("FILE_ID", GetType(Integer))
                CLS_AMT.Columns.Add("BATCH_ID", GetType(Integer))
                CLS_AMT.Columns.Add("ISA_ID", GetType(Integer))
                CLS_AMT.Columns.Add("GS_ID", GetType(Integer))
                CLS_AMT.Columns.Add("ST_ID", GetType(Integer))
                CLS_AMT.Columns.Add("HIPAA_ISA_GUID", GetType(Guid))
                CLS_AMT.Columns.Add("HIPAA_GS_GUID", GetType(Guid))
                CLS_AMT.Columns.Add("HIPAA_ST_GUID", GetType(Guid))
                CLS_AMT.Columns.Add("HIPAA_HL_20_GUID", GetType(Guid))
                CLS_AMT.Columns.Add("HIPAA_HL_21_GUID", GetType(Guid))
                CLS_AMT.Columns.Add("HIPAA_HL_22_GUID", GetType(Guid))
                CLS_AMT.Columns.Add("HIPAA_HL_23_GUID", GetType(Guid))
                CLS_AMT.Columns.Add("HIPAA_HL_24_GUID", GetType(Guid))
                CLS_AMT.Columns.Add("276_ISL_GUID", GetType(Guid))
                CLS_AMT.Columns.Add("276_IRL_GUID", GetType(Guid))
                CLS_AMT.Columns.Add("276_SPL_GUID", GetType(Guid))
                CLS_AMT.Columns.Add("276_CLS_GUID", GetType(Guid))
                CLS_AMT.Columns.Add("276_SLS_GUID", GetType(Guid))
                CLS_AMT.Columns.Add("HL01", GetType(Integer))
                CLS_AMT.Columns.Add("HL02", GetType(Integer))
                CLS_AMT.Columns.Add("HL03", GetType(Integer))
                CLS_AMT.Columns.Add("HL04", GetType(Integer))
                CLS_AMT.Columns.Add("AMT01", GetType(String))
                CLS_AMT.Columns.Add("AMT02", GetType(String))
                CLS_AMT.Columns.Add("AMT03", GetType(String))
                CLS_AMT.Columns.Add("ROW_NUMBER", GetType(Integer))
                CLS_AMT.Columns.Add("LOOP_LEVEL_MAJOR", GetType(Integer))
                CLS_AMT.Columns.Add("LOOP_LEVEL_MINOR", GetType(Integer))
                CLS_AMT.Columns.Add("LOOP_LEVEL_SUBFIX", GetType(String))
            Catch ex As Exception
            ...
            Try
                ...
                DMG.Columns.Add("HIPAA_HL_19_GUID", GetType(Guid))
                ...
                DMG.Columns.Add("276_ISL_GUID", GetType(Guid))
                DMG.Columns.Add("276_IRL_GUID", GetType(Guid))
                DMG.Columns.Add("276_SPL_GUID", GetType(Guid))
                DMG.Columns.Add("276_CLS_GUID", GetType(Guid))
                DMG.Columns.Add("276_SLS_GUID", GetType(Guid))
            ...
            Try
                ...
                CLS_DMG.Columns.Add("ROW_ID", GetType(Integer)).AutoIncrement = True
                CLS_DMG.Columns.Add("DOCUMENT_ID", GetType(Integer))
                CLS_DMG.Columns.Add("FILE_ID", GetType(Integer))
                CLS_DMG.Columns.Add("BATCH_ID", GetType(Integer))
                CLS_DMG.Columns.Add("ISA_ID", GetType(Integer))
                CLS_DMG.Columns.Add("GS_ID", GetType(Integer))
                CLS_DMG.Columns.Add("ST_ID", GetType(Integer))
                CLS_DMG.Columns.Add("HIPAA_ISA_GUID", GetType(Guid))
                CLS_DMG.Columns.Add("HIPAA_GS_GUID", GetType(Guid))
                CLS_DMG.Columns.Add("HIPAA_ST_GUID", GetType(Guid))
                CLS_DMG.Columns.Add("HIPAA_HL_19_GUID", GetType(Guid))
                CLS_DMG.Columns.Add("HIPAA_HL_20_GUID", GetType(Guid))
                CLS_DMG.Columns.Add("HIPAA_HL_21_GUID", GetType(Guid))
                CLS_DMG.Columns.Add("HIPAA_HL_22_GUID", GetType(Guid))
                CLS_DMG.Columns.Add("HIPAA_HL_23_GUID", GetType(Guid))
                CLS_DMG.Columns.Add("HIPAA_HL_24_GUID", GetType(Guid))
                CLS_DMG.Columns.Add("276_ISL_GUID", GetType(Guid))
                CLS_DMG.Columns.Add("276_IRL_GUID", GetType(Guid))
                CLS_DMG.Columns.Add("276_SPL_GUID", GetType(Guid))
                CLS_DMG.Columns.Add("276_CLS_GUID", GetType(Guid))
                CLS_DMG.Columns.Add("276_SLS_GUID", GetType(Guid))
                CLS_DMG.Columns.Add("HL01", GetType(Integer))
                CLS_DMG.Columns.Add("HL02", GetType(Integer))
                CLS_DMG.Columns.Add("HL03", GetType(Integer))
                CLS_DMG.Columns.Add("HL04", GetType(Integer))
                CLS_DMG.Columns.Add("DMG01", GetType(String))
                CLS_DMG.Columns.Add("DMG02", GetType(String))
                CLS_DMG.Columns.Add("DMG03", GetType(String))
                CLS_DMG.Columns.Add("ROW_NUMBER", GetType(Integer))
                CLS_DMG.Columns.Add("LOOP_LEVEL_MAJOR", GetType(Integer))
                CLS_DMG.Columns.Add("LOOP_LEVEL_MINOR", GetType(Integer))
                CLS_DMG.Columns.Add("LOOP_LEVEL_SUBFIX", GetType(String))
            Catch ex As Exception
            ...
            Try
                ...
                CSR_DMG.Columns.Add("ROW_ID", GetType(Integer)).AutoIncrement = True
                CSR_DMG.Columns.Add("DOCUMENT_ID", GetType(Integer))
                CSR_DMG.Columns.Add("FILE_ID", GetType(Integer))
                CSR_DMG.Columns.Add("BATCH_ID", GetType(Integer))
                CSR_DMG.Columns.Add("ISA_ID", GetType(Integer))
                CSR_DMG.Columns.Add("GS_ID", GetType(Integer))
                CSR_DMG.Columns.Add("ST_ID", GetType(Integer))
                CSR_DMG.Columns.Add("HIPAA_ISA_GUID", GetType(Guid))
                CSR_DMG.Columns.Add("HIPAA_GS_GUID", GetType(Guid))
                CSR_DMG.Columns.Add("HIPAA_ST_GUID", GetType(Guid))
                CSR_DMG.Columns.Add("HIPAA_HL_19_GUID", GetType(Guid))
                CSR_DMG.Columns.Add("HIPAA_HL_20_GUID", GetType(Guid))
                CSR_DMG.Columns.Add("HIPAA_HL_21_GUID", GetType(Guid))
                CSR_DMG.Columns.Add("HIPAA_HL_22_GUID", GetType(Guid))
                CSR_DMG.Columns.Add("HIPAA_HL_23_GUID", GetType(Guid))
                CSR_DMG.Columns.Add("HIPAA_HL_24_GUID", GetType(Guid))
                CSR_DMG.Columns.Add("276_ISL_GUID", GetType(Guid))
                CSR_DMG.Columns.Add("276_IRL_GUID", GetType(Guid))
                CSR_DMG.Columns.Add("276_SPL_GUID", GetType(Guid))
                CSR_DMG.Columns.Add("276_CLS_GUID", GetType(Guid))
                CSR_DMG.Columns.Add("276_SLS_GUID", GetType(Guid))
                CSR_DMG.Columns.Add("HL01", GetType(Integer))
                CSR_DMG.Columns.Add("HL02", GetType(Integer))
                CSR_DMG.Columns.Add("HL03", GetType(Integer))
                CSR_DMG.Columns.Add("HL04", GetType(Integer))
                CSR_DMG.Columns.Add("DMG01", GetType(String))
                CSR_DMG.Columns.Add("DMG02", GetType(String))
                CSR_DMG.Columns.Add("DMG03", GetType(String))
                CSR_DMG.Columns.Add("ROW_NUMBER", GetType(Integer))
                CSR_DMG.Columns.Add("LOOP_LEVEL_MAJOR", GetType(Integer))
                CSR_DMG.Columns.Add("LOOP_LEVEL_MINOR", GetType(Integer))
                CSR_DMG.Columns.Add("LOOP_LEVEL_SUBFIX", GetType(String))
            Catch ex As Exception
            ...
            Try
                ...
                DTP.Columns.Add("276_ISL_GUID", GetType(Guid))
                DTP.Columns.Add("276_IRL_GUID", GetType(Guid))
                DTP.Columns.Add("276_SPL_GUID", GetType(Guid))
                DTP.Columns.Add("276_CLS_GUID", GetType(Guid))
                DTP.Columns.Add("276_SLS_GUID", GetType(Guid))
            ...
            Try
                ...
                CLS_DTP.Columns.Add("276_ISL_GUID", GetType(Guid))
                CLS_DTP.Columns.Add("276_IRL_GUID", GetType(Guid))
                CLS_DTP.Columns.Add("276_SPL_GUID", GetType(Guid))
                CLS_DTP.Columns.Add("276_CLS_GUID", GetType(Guid))
                CLS_DTP.Columns.Add("276_SLS_GUID", GetType(Guid))
            ...
            Try
                CSR_DTP.Columns.Add("ROW_ID", GetType(Integer)).AutoIncrement = True
                CSR_DTP.Columns.Add("DOCUMENT_ID", GetType(Integer))
                CSR_DTP.Columns.Add("FILE_ID", GetType(Integer))
                CSR_DTP.Columns.Add("BATCH_ID", GetType(Integer))
                CSR_DTP.Columns.Add("ISA_ID", GetType(Integer))
                CSR_DTP.Columns.Add("GS_ID", GetType(Integer))
                CSR_DTP.Columns.Add("ST_ID", GetType(Integer))
                CSR_DTP.Columns.Add("HIPAA_ISA_GUID", GetType(Guid))
                CSR_DTP.Columns.Add("HIPAA_GS_GUID", GetType(Guid))
                CSR_DTP.Columns.Add("HIPAA_ST_GUID", GetType(Guid))
                CSR_DTP.Columns.Add("HIPAA_HL_20_GUID", GetType(Guid))
                CSR_DTP.Columns.Add("HIPAA_HL_21_GUID", GetType(Guid))
                CSR_DTP.Columns.Add("HIPAA_HL_22_GUID", GetType(Guid))
                CSR_DTP.Columns.Add("HIPAA_HL_23_GUID", GetType(Guid))
                CSR_DTP.Columns.Add("HIPAA_HL_24_GUID", GetType(Guid))
                CSR_DTP.Columns.Add("276_ISL_GUID", GetType(Guid))
                CSR_DTP.Columns.Add("276_IRL_GUID", GetType(Guid))
                CSR_DTP.Columns.Add("276_SPL_GUID", GetType(Guid))
                CSR_DTP.Columns.Add("276_CLS_GUID", GetType(Guid))
                CSR_DTP.Columns.Add("276_SLS_GUID", GetType(Guid))
                CSR_DTP.Columns.Add("HL01", GetType(Integer))
                CSR_DTP.Columns.Add("HL02", GetType(Integer))
                CSR_DTP.Columns.Add("HL03", GetType(Integer))
                CSR_DTP.Columns.Add("HL04", GetType(Integer))
                CSR_DTP.Columns.Add("DTP01", GetType(String))
                CSR_DTP.Columns.Add("DTP02", GetType(String))
                CSR_DTP.Columns.Add("DTP03", GetType(String))
                CSR_DTP.Columns.Add("ROW_NUMBER", GetType(Integer))
                CSR_DTP.Columns.Add("LOOP_LEVEL_MAJOR", GetType(Integer))
                CSR_DTP.Columns.Add("LOOP_LEVEL_MINOR", GetType(Integer))
                CSR_DTP.Columns.Add("LOOP_LEVEL_SUBFIX", GetType(String))
            Catch ex As Exception
            ...
            Try
                ...
                NM1.Columns.Add("276_ISL_GUID", GetType(Guid))
                NM1.Columns.Add("276_IRL_GUID", GetType(Guid))
                NM1.Columns.Add("276_SPL_GUID", GetType(Guid))
                NM1.Columns.Add("276_CLS_GUID", GetType(Guid))
                NM1.Columns.Add("276_SLS_GUID", GetType(Guid))
            ...
            Try
                ...
                CACHE_NM1.Columns.Add("276_ISL_GUID", GetType(Guid))
                CACHE_NM1.Columns.Add("276_IRL_GUID", GetType(Guid))
                CACHE_NM1.Columns.Add("276_SPL_GUID", GetType(Guid))
                CACHE_NM1.Columns.Add("276_CLS_GUID", GetType(Guid))
                CACHE_NM1.Columns.Add("276_SLS_GUID", GetType(Guid))
            ...
            Try
                CSR_NM1.Columns.Add("ROW_ID", GetType(Integer)).AutoIncrement = True
                CSR_NM1.Columns.Add("DOCUMENT_ID", GetType(Integer))
                CSR_NM1.Columns.Add("FILE_ID", GetType(Integer))
                CSR_NM1.Columns.Add("BATCH_ID", GetType(Integer))
                CSR_NM1.Columns.Add("ISA_ID", GetType(Integer))
                CSR_NM1.Columns.Add("GS_ID", GetType(Integer))
                CSR_NM1.Columns.Add("ST_ID", GetType(Integer))
                CSR_NM1.Columns.Add("HIPAA_ISA_GUID", GetType(Guid))
                CSR_NM1.Columns.Add("HIPAA_GS_GUID", GetType(Guid))
                CSR_NM1.Columns.Add("HIPAA_ST_GUID", GetType(Guid))
                CSR_NM1.Columns.Add("HIPAA_HL_19_GUID", GetType(Guid))
                CSR_NM1.Columns.Add("HIPAA_HL_20_GUID", GetType(Guid))
                CSR_NM1.Columns.Add("HIPAA_HL_21_GUID", GetType(Guid))
                CSR_NM1.Columns.Add("HIPAA_HL_22_GUID", GetType(Guid))
                CSR_NM1.Columns.Add("HIPAA_HL_23_GUID", GetType(Guid))
                CSR_NM1.Columns.Add("HIPAA_HL_24_GUID", GetType(Guid))
                CSR_NM1.Columns.Add("276_ISL_GUID", GetType(Guid))
                CSR_NM1.Columns.Add("276_IRL_GUID", GetType(Guid))
                CSR_NM1.Columns.Add("276_SPL_GUID", GetType(Guid))
                CSR_NM1.Columns.Add("276_CLS_GUID", GetType(Guid))
                CSR_NM1.Columns.Add("276_SLS_GUID", GetType(Guid))
                CSR_NM1.Columns.Add("HL01", GetType(Integer))
                CSR_NM1.Columns.Add("HL02", GetType(Integer))
                CSR_NM1.Columns.Add("HL03", GetType(Integer))
                CSR_NM1.Columns.Add("HL04", GetType(Integer))
                CSR_NM1.Columns.Add("NM101", GetType(String))
                CSR_NM1.Columns.Add("NM102", GetType(String))
                CSR_NM1.Columns.Add("NM103", GetType(String))
                CSR_NM1.Columns.Add("NM104", GetType(String))
                CSR_NM1.Columns.Add("NM105", GetType(String))
                CSR_NM1.Columns.Add("NM106", GetType(String))
                CSR_NM1.Columns.Add("NM107", GetType(String))
                CSR_NM1.Columns.Add("NM108", GetType(String))
                CSR_NM1.Columns.Add("NM109", GetType(String))
                CSR_NM1.Columns.Add("NM110", GetType(String))
                CSR_NM1.Columns.Add("NM111", GetType(String))
                CSR_NM1.Columns.Add("ROW_NUMBER", GetType(Integer))
                CSR_NM1.Columns.Add("LOOP_LEVEL_MAJOR", GetType(Integer))
                CSR_NM1.Columns.Add("LOOP_LEVEL_MINOR", GetType(Integer))
                CSR_NM1.Columns.Add("LOOP_LEVEL_SUBFIX", GetType(String))
            ...
            Try
                ...
                REF.Columns.Add("276_ISL_GUID", GetType(Guid))
                REF.Columns.Add("276_IRL_GUID", GetType(Guid))
                REF.Columns.Add("276_SPL_GUID", GetType(Guid))
                REF.Columns.Add("276_CLS_GUID", GetType(Guid))
                REF.Columns.Add("276_SLS_GUID", GetType(Guid))
            ...
            Try
                ...
                CLS_REF.Columns.Add("276_ISL_GUID", GetType(Guid))
                CLS_REF.Columns.Add("276_IRL_GUID", GetType(Guid))
                CLS_REF.Columns.Add("276_SPL_GUID", GetType(Guid))
                CLS_REF.Columns.Add("276_CLS_GUID", GetType(Guid))
                CLS_REF.Columns.Add("276_SLS_GUID", GetType(Guid))
            ...
            Try
                ...
                STC.Columns.Add("276_ISL_GUID", GetType(Guid))
                STC.Columns.Add("276_IRL_GUID", GetType(Guid))
                STC.Columns.Add("276_SPL_GUID", GetType(Guid))
                STC.Columns.Add("276_CLS_GUID", GetType(Guid))
                STC.Columns.Add("276_SLS_GUID", GetType(Guid))
            ...
            Try
                ...
                CACHE_STC.Columns.Add("276_ISL_GUID", GetType(Guid))
                CACHE_STC.Columns.Add("276_IRL_GUID", GetType(Guid))
                CACHE_STC.Columns.Add("276_SPL_GUID", GetType(Guid))
                CACHE_STC.Columns.Add("276_CLS_GUID", GetType(Guid))
                CACHE_STC.Columns.Add("276_SLS_GUID", GetType(Guid))
            ...
            Try
                ...
                CLS_STC.Columns.Add("276_ISL_GUID", GetType(Guid))
                CLS_STC.Columns.Add("276_IRL_GUID", GetType(Guid))
                CLS_STC.Columns.Add("276_SPL_GUID", GetType(Guid))
                CLS_STC.Columns.Add("276_CLS_GUID", GetType(Guid))
                CLS_STC.Columns.Add("276_SLS_GUID", GetType(Guid))
            ...
            Try
                ...
                SVC.Columns.Add("276_ISL_GUID", GetType(Guid))
                SVC.Columns.Add("276_IRL_GUID", GetType(Guid))
                SVC.Columns.Add("276_SPL_GUID", GetType(Guid))
                SVC.Columns.Add("276_CLS_GUID", GetType(Guid))
                SVC.Columns.Add("276_SLS_GUID", GetType(Guid))
            ...
            Try
                ...
                TRN.Columns.Add("276_ISL_GUID", GetType(Guid))
                TRN.Columns.Add("276_IRL_GUID", GetType(Guid))
                TRN.Columns.Add("276_SPL_GUID", GetType(Guid))
                TRN.Columns.Add("276_CLS_GUID", GetType(Guid))
                TRN.Columns.Add("276_SLS_GUID", GetType(Guid))
            ...
            Try
                ...
                CACHE_TRN.Columns.Add("276_ISL_GUID", GetType(Guid))
                CACHE_TRN.Columns.Add("276_IRL_GUID", GetType(Guid))
                CACHE_TRN.Columns.Add("276_SPL_GUID", GetType(Guid))
                CACHE_TRN.Columns.Add("276_CLS_GUID", GetType(Guid))
                CACHE_TRN.Columns.Add("276_SLS_GUID", GetType(Guid))
            ...
            Try
                ...
                CLS_TRN.Columns.Add("276_ISL_GUID", GetType(Guid))
                CLS_TRN.Columns.Add("276_IRL_GUID", GetType(Guid))
                CLS_TRN.Columns.Add("276_SPL_GUID", GetType(Guid))
                CLS_TRN.Columns.Add("276_CLS_GUID", GetType(Guid))
                CLS_TRN.Columns.Add("276_SLS_GUID", GetType(Guid))
