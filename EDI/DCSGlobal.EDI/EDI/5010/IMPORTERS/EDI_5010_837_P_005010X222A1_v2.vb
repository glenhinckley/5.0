...
Namespace DCSGlobal.EDI
    Public Class EDI_5010_837P_005010X222A1_v2
        ...
        Private _SP_COMIT_HL22_UNIT_DATA As String = "[usp_EDI_5010_HIPAA_837_22_UNIT_TEST]"
        ...
        Public Sub New()
            ...
            _CONSOLE_NAME = "EDI_5010_837P_005010X222A1_v2"
            _CLASS_NAME = "EDI_5010_837P_005010X222A1_v2"
        ...
        Public Function Import(ByVal EDIList As List(Of String)) As Integer
            ...
            If (_IS_FILE) Then
                Using e As New EDI_5010_LOGGING
                    e.ConnectionString = _ConnectionString
                    e.TransactionSetIdentifierCode = "837"
                    e.UpdateFileStatus(CInt(_FILE_ID), "837", "BEGIN PARSE")
                End Using
            End If
            ...
            If _SP_DO_TEST = 1 Then
                ...
                If (_SP_RETURN_CODE <> 0) Then
                    _IMPORT_RETURN_STRING = "837P : SP TEST FAILED WITH ERROR CODE " + Convert.ToString(_SP_RETURN_CODE)
            ...
            For Each line As String In EDIList
                ...
                Catch ex As Exception
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "HL NASTY", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "CLM", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "LX", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "SVD", ex)
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "CAS", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "CR1", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "HI", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "CRC", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "LIN", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "K3", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "MIA", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "MOA", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "N3", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "NTE", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "OI", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "PAT", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "PRV", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "PWK", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "SV1", ex)
                End Try
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -2
                    _hasERR = True
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "SV5", ex)
                End Try
            ...
            'If _hasERR Then
            '    '' RollBack()
            '    _IMPORT_RETURN_STRING = _IMPORT_RETURN_STRING
            'End If
        ...
        Private Function ComitIEA() As Integer
            ...
            _FUNCTION_NAME = "Function iea() As Integer"
