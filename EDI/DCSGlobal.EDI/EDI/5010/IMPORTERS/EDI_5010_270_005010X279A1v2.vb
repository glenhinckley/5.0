...
Namespace DCSGlobal.EDI
    ...
    Public Class EDI_270_005010X279A1
            ...
            Try
                Using Con As New SqlConnection(_ConnectionString)
                    ...
                    Using cmd As New SqlCommand(_SP_ISA, Con)
                        ...
                        cmd.Parameters.Add("@batch_id", Data.SqlDbType.BigInt, 1)
            ...
            Try
                ...
                Using Con As New SqlConnection(_ConnectionString)
                    ...
                    Using cmd As New SqlCommand(_SP_COMIT_HL22_DATA, Con)
                        ...
                        'r = Convert.ToInt32(cmd.Parameters("@batch_id").Direction = ParameterDirection.Output)
