...
Namespace DCSGlobal.EDI
    Public Class EDI_5010_837I_005010X223A2
        ...
        Public Function Import(ByVal EDIList As List(Of String)) As Int32
            ...
            For Each line As String In EDIList
                ...
                Catch ex As Exception
                    _hasERR = True
                    _ERROR = ex.Message
                    log.ExceptionDetails("hl nasty 005010X223A2", ex)
                End Try
                ...
                Catch ex As Exception
                    _hasERR = True
                    _ERROR = ex.Message
                    log.ExceptionDetails("CR1 005010X223A2", ex)
                End Try
                ...
                Catch ex As Exception
                    _hasERR = True
                    _ERROR = ex.Message
                    log.ExceptionDetails("lin 005010X223A2", ex)
                End Try
                ...
                Catch ex As Exception
                    ...
                    _hasERR = True
                    _ERROR = ex.Message
                    log.ExceptionDetails("PRV 005010X223A2", ex)
                End Try
                ...
                Catch ex As Exception
                    ...
                    _hasERR = True
                    _ERROR = ex.Message
                    log.ExceptionDetails("PWK 005010X223A2", ex)
                End Try
                ...
                Catch ex As Exception
                    _hasERR = True
                    _ERROR = ex.Message
                    log.ExceptionDetails("UNK 005010X223A2", ex)
                End Try
            ...
            Try
                ...
                Using Con As New SqlConnection(_ConnectionString)
                    ...
                    Using cmd As New SqlCommand(_SP_COMIT_UNKNOWN, Con)
                        ...
                        cmd.Parameters.AddWithValue("@IMPORTER", "EDI_5010_837I_005010X223A2")
                        cmd.ExecuteNonQuery()
        ...
        Private Function RollBack() As Integer
            ...
            Catch ex As Exception
                log.ExceptionDetails("ROLL_BACK 005010X223A2", ex)
            End Try
        ...
        Public Function TestSPs() As Integer
            ...
            Catch ex As Exception
                ...
                log.ExceptionDetails("HL 22 TEST FAILED 005010X223A2", ex)
            End Try
