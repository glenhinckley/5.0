...
Namespace DCSGlobal.EDI
    ...
    Public Class EDI_5010_276_005010X212
        ...
        Private _SP_COMIT_HL22_UNIT_DATA As String = "[usp_EDI_5010_HIPAA_276_22_UNIT_TEST]"
        ...
        Public Function Import(ByVal EDIList As List(Of String)) As Int32
            ...
            '    Comit_CLAIM_STATUS_AUDIT_RAW_REQUEST()
            ...
            For Each line As String In EDIList
                ...
                Catch ex As Exception
                    _RowProcessedFlag = -1
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "ISA 005010X212_276", ex)
                End Try
                ...
                Catch ex As Exception
                    ...
                    _hasERR = True
                    _ERROR = ex.Message
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "GS 005010X212_276", ex)
                End Try
                ...
                Catch ex As Exception
                    ...
                    _ERROR = ex.Message
                    _RowProcessedFlag = -1
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "ST 005010X212_276", ex)
                End Try
                ...
                Catch ex As Exception
                    ...
                    _ERROR = ex.Message
                    _RowProcessedFlag = -1
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "HL 005010X212_276", ex)
                End Try
                ...
                If _LoopLevelMajor = 2000 And _LoopLevelMinor = 200 Then
                    isCLS_ON_DISC = False
                    ...
                    Catch ex As Exception
                        ...
                        _ERROR = ex.Message
                        _RowProcessedFlag = -1
                        log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "TRN 005010X212_276", ex)
                    End Try
                    ...
                    Try
                        If _RowRecordType = "REF" Then
                            ...
                            REFRow("276_SLS_GUID") = Guid.Empty
                            REFRow("HL01") = _HL01
                            REFRow("HL02") = _HL02
                            REFRow("HL03") = _HL03
                            REFRow("HL04") = _HL04
                    ...
                    Catch ex As Exception
                        _hasERR = True
                        _ERROR = ex.Message
                        log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "REF 005010X212_276", ex)
                    End Try
                    ...
                    Catch ex As Exception
                        ...
                        _ERROR = ex.Message
                        _RowProcessedFlag = -1
                        log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "AMT 005010X212_276", ex)
                    End Try
                    ...
                    Try
                        If _RowRecordType = "DTP" Then
                            ...
                            DTPRow("276_SLS_GUID") = Guid.Empty
                            DTPRow("HL01") = _HL01
                            DTPRow("HL02") = _HL02
                            DTPRow("HL03") = _HL03
                            DTPRow("HL04") = _HL04
                    ...
                    Catch ex As Exception
                        ...
                        _ERROR = ex.Message
                        _RowProcessedFlag = -1
                        log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "DTP 005010X212_276", ex)
                    End Try
                ...
                If _LoopLevelMajor = 2000 And _LoopLevelMinor = 210 Then
                    ...
                    Try
                        ...
                        If _RowRecordType = "SVC" Then
                            ...
                            SVCRow("276_ISL_GUID") = _276_ISL_GUID
                            SVCRow("276_IRL_GUID") = _276_IRL_GUID
                            SVCRow("276_SPL_GUID") = _276_SPL_GUID
                            SVCRow("276_CLS_GUID") = _276_CLS_GUID
                            SVCRow("276_SLS_GUID") = _276_SLS_GUID
                            SVCRow("HL01") = _HL01
                            SVCRow("HL02") = _HL02
                            SVCRow("HL03") = _HL03
                            SVCRow("HL04") = _HL04
                            ...
                            If (ss.ParseDemlimtedString(_CurrentRowData, _DataElementSeparator, 7) <> "") Then SVCRow("SVC06") = ss.ParseDemlimtedString(_CurrentRowData, _DataElementSeparator, 7) Else SVCRow("SVC06") = DBNull.Value
                    ...
                    Catch ex As Exception
                        ...
                        _hasERR = True
                        _ERROR = ex.Message
                        log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "SVC 210 005010X212_276", ex)
                    End Try
                    ...
                    Catch ex As Exception
                        _hasERR = True
                        _ERROR = ex.Message
                        log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "REF 210 005010X212_276", ex)
                    ...
                    Catch ex As Exception
                        ...
                        _ERROR = ex.Message
                        _RowProcessedFlag = -1
                        log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "DTP 210 005010X212_276", ex)
                    End Try
                ...
                'Catch ex As Exception
                '    _RowProcessedFlag = -1
                '    '  log.ExceptionDetails("DTP", _DocumentType, ex)
                'End Try
                ...
                Catch ex As Exception
                    ...
                    _ERROR = ex.Message
                    _RowProcessedFlag = -1
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "DMG 210 005010X212_276", ex)
                End Try
                ...
                Catch ex As Exception
                    ...
                    _ERROR = ex.Message
                    _RowProcessedFlag = -1
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "NM1 210 005010X212_276", ex)
                End Try
                ...
                Catch ex As Exception
                    _hasERR = True
                    _ERROR = ex.Message
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "SE 005010X212_276", ex)
                End Try
                ...
                Catch ex As Exception
                    _hasERR = True
                    _ERROR = ex.Message
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "GE 005010X212_276", ex)
                End Try
                ...
                Catch ex As Exception
                    _hasERR = True
                    _ERROR = ex.Message
                    log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "IEA 005010X212_276", ex)
                End Try
            ...
            If _hasUNK Then
                Using e As New EDI_5010_LOGGING
                    ...
                    e.TransactionSetIdentifierCode = "276"
                    If _hasERR Then
                        e.UpdateFileStatus(CInt(_FILE_ID), "276", "PARSE COMPLETE WITH UNK SEGMENTS WITH ERRORS")
                    Else
                        e.UpdateFileStatus(CInt(_FILE_ID), "276", "PARSE COMPLETE WITH UNK SEGMENTS")
                    End If
            ...
            Else
                ...
                Using e As New EDI_5010_LOGGING
                    ...
                    e.TransactionSetIdentifierCode = "276"
                    If _hasERR Then
                        e.UpdateFileStatus(CInt(_FILE_ID), "276", "PARSE COMPLETE WITH ERRORS")
                    Else
                        e.UpdateFileStatus(CInt(_FILE_ID), "276", "PARSE COMPLETE")
                    End If
                End Using
        ...
        Private Function ComitUNK() As Integer
            ...
            Try
                ...
                Using Con As New SqlConnection(_ConnectionString)
                    ...
                    Using cmd As New SqlCommand(_SP_COMIT_UNKNOWN, Con)
                        ...
                        cmd.Parameters.AddWithValue("@IMPORTER", "EDI_5010_276_005010X212")
                        cmd.ExecuteNonQuery()
            ...
            Catch ex As Exception
                _hasERR = True
                _ERROR = ex.Message
                log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "COMIT_UNK_DATA 005010X212_276", ex)
            End Try
        ...
        Private Function Cleanup() As Int32
            ...
            Catch ex As Exception
                _hasERR = True
                _ERROR = ex.Message
                log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "CLEANUP 005010X212_276", ex)
            End Try
        ...
        Private Function ComitISA() As Integer
            ...
            Catch ex As Exception
                ...
                _ERROR = ex.Message
                i = -1
                log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "COMIT_ISA_DATA 005010X212_276", ex)
            End Try
        ...
        Private Function ComitGS() As Integer
            ...
            Catch ex As Exception
                _hasERR = True
                _ERROR = ex.Message
                log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "COMIT_GS_DATA 005010X212_276", ex)
            End Try
        ...
        Private Function ComitST() As Int32
            ...
            Catch ex As Exception
                _hasERR = True
                _ERROR = ex.Message
                log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "COMIT_ST_DATA 005010X212_276", ex)
            End Try
        ...
        Private Function ComitHL20() As Integer
            ...
            Catch ex As Exception
                _hasERR = True
                _ERROR = ex.Message
                log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "COMIT_HEADER_DATA 005010X212_276", ex)
            End Try
        ...
        Private Function ComitHL22() As Integer
            ...
            Catch ex As Exception
                _hasERR = True
                _ERROR = ex.Message
                log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "COMIT_ROW_DATA 005010X212_276", ex)
            End Try
        ...
        ' ''' <returns></returns>
        ' ''' <remarks></remarks>
        'Private Function Comit_CLAIM_STATUS_AUDIT_RAW_REQUEST() As Int32
        '    Dim r As Integer

        '    Dim sq As String = "[usp_EDI_5010_HIPAA_276_CLAIM_STATUS_AUDIT_RAW_REQUEST]"
        ...
        '    Catch ex As Exception
        '        log.ExceptionDetails("COMIT_SE_DATA 005010X212_276", ex)
        '    End Try
        ...
        Private Function ComitSE() As Int32
            ...
            Try
                Using Con As New SqlConnection(_ConnectionString)
                    ...
                    Using cmd As New SqlCommand(_SP_SE, Con)
                        ...
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Parameters.AddWithValue("@HIPAA_276_SE", SE)
                        cmd.ExecuteNonQuery()
            ...
            Catch ex As Exception
                _hasERR = True
                _ERROR = ex.Message
                log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "COMIT_SE_DATA 005010X212_276", ex)
            End Try
        ...
        Private Function ComitGE() As Integer
            ...
            Try
                ...
                Using Con As New SqlConnection(_ConnectionString)
                    ...
                    Using cmd As New SqlCommand(_SP_GE, Con)
                        ...
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Parameters.AddWithValue("@HIPAA_276_GE", GE)
            ...
            Catch ex As Exception
                _hasERR = True
                _ERROR = ex.Message
                log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "COMIT_GE_DATA 005010X212_276", ex)
            End Try
        ...
        Private Function ComitIEA() As Integer
            ...
            Try
                ...
                Using Con As New SqlConnection(_ConnectionString)
                    ...
                    Using cmd As New SqlCommand(_SP_IEA, Con)
                        ...
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Parameters.AddWithValue("@HIPAA_276_IEA", IEA)
                        cmd.ExecuteNonQuery()
            ...
            Catch ex As Exception
                _hasERR = True
                _ERROR = ex.Message
                log.ExceptionDetails(_CONSOLE_NAME, _CLASS_NAME, _FUNCTION_NAME, "COMIT_IEA_DATA 005010X212_276", ex)
            End Try
        ...
        Private Function RollBack() As Integer
            ...
            Catch ex As Exception
                log.ExceptionDetails("ROLL_BACK 005010X212_276", ex)
            End Try
        ...
        Public Function TestSPs() As Integer
            ...
            Catch ex As Exception
                ...
                log.ExceptionDetails("HL 22 TEST FAILED 005010X212_276", ex)
            End Try
        ...
        Public Sub BUILD_CSR_NM1(ByVal NM1_ROWDATA As String)
            ...
            CSR_NM1Row("ROW_NUMBER") = rowcount
