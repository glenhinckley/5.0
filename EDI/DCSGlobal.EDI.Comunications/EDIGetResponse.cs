...
{
    public class EDIGetResponse : IDisposable
    {
                ...
                switch (VendorName.ToUpper())
                {
                    ...
                    case "AVAILITY_OLD":
                        ...
                        using (AvailityEx avlt = new AvailityEx())
                        {
                            ...
                            avlt.ProtocolType = c.ProtocolType;
                    ...
                    case "AVAILITY":
                        ...
                        using (AvailitySoap avltsoap = new AvailitySoap())
                        {
                            ...
                            avltsoap.ProtocolType = c.ProtocolType;
                    ...
                    case "IVANS":
                        using (IvansEx ivns = new IvansEx())
                        {
                            ...
                            ivns.ProtocolType = c.ProtocolType;
                            r = ivns.GetResponse();
                            if (r == 0)
                            {
                                _RES = ivns.RES;
                    ...
                    case "VISIONSHARE":
                        using (VisionShareEx vision = new VisionShareEx())
                        {
                            ...
                            vision.ProtocolType = c.ProtocolType;
                            vision.REQ = _REQ;
                    ...
                    case "PNT":
                        ...
                        using (PNTEx pnt = new PNTEx())
                        {
                            ...
                            pnt.ProtocolType = c.ProtocolType;
                            r = pnt.GetResponse();
                            if (r == 0)
                            {
                                _RES = pnt.RES;
                    ...
                    case "EMDEONLOOKUP":
                        using (EmdeonEx emdlkp = new EmdeonEx())
                        {
                            ...
                            emdlkp.ProtocolType = c.ProtocolType;
                            if (!_isTest)
                    ...
                    case "EMDEON":
                        using (EmdeonOnly emdonly = new EmdeonOnly())
                        {
                            ...
                            emdonly.ProtocolType = c.ProtocolType;
                            if (!_isTest)
                    ...
                    case "DORADO":
                        ...
                        using (DoradoSystemsEx dor = new DoradoSystemsEx())
                        {
                            ...
                            dor.ProtocolType = c.ProtocolType;
                    ...
                    case "PARAMOUNTEDI":
                        using (ParamountHealthEx paramount = new ParamountHealthEx())
                        {
                            ...
                            paramount.ProtocolType = c.ProtocolType;
                            ...
                            else
                            {
                                r = -1;
                                _OrigRES = paramount.OrigRes;
                                log.ExceptionDetails("1165-DCSGlobal.EDI.Comunications.EDI.PARAMOUNT.GetResponse Failed. Batch ID:" + Convert.ToString(_BatchID), "GetResponse Failed r =" + Convert.ToString(r));
                            }
                        }
                        break;
                    ...
                    case "TXMCD_DIRECT":
                        using (TexasMedicaidHealthcarePartnershipEx txs = new TexasMedicaidHealthcarePartnershipEx())
                        {
                            ...
                            txs.wsUrl = c.wsUrl;
                            txs.ProtocolType = c.ProtocolType;
                            txs.TaskID = _TaskID;
                            txs.EBRID = _EBRID;
                    ...
                    case "TXMCD":
                        using (TexasMedicaidHealthcarePartnershipDCSWebServiceEx dtxs = new TexasMedicaidHealthcarePartnershipDCSWebServiceEx())
                        {
                            ...
                            dtxs.ProtocolType = c.ProtocolType;
                            if (!_isTest)
                            { dtxs.wsUrl = c.wsUrl; }
                            else
                    ...
                    case "MEDDATA":
                        ...
                        using (MedDataEx md = new MedDataEx())
                        {
                            ...
                            md.ProtocolType = c.ProtocolType;
                    ...
                    case "MEMCD":
                        using (MaineMedicaidEx memcd = new MaineMedicaidEx())
                        {
                            ...
                            memcd.wsUrl = c.wsUrl;
                            memcd.ProtocolType = c.ProtocolType;
                    ...
                    case "ARMCD":
                        using (ArkansasMedicaidEx armcd = new ArkansasMedicaidEx())
                        {
                            ...
                            armcd.ProtocolType = c.ProtocolType;
                    ...
                    case "NEMCD":
                        using (NebraskaMedicaid nemcd = new NebraskaMedicaid())
                        {
                            ...
                            nemcd.ProtocolType = c.ProtocolType;
                    ...
                    case "GAMCD":
                        ...
                        using (GeorgiaMedicaidEx grmcd = new GeorgiaMedicaidEx())
                        {
                            ...
                            grmcd.ProtocolType = c.ProtocolType;
                    ...
                    case "ALMCD":
                        using (AlbamaMedicaidEx albama = new AlbamaMedicaidEx())
                        {
                            ...
                            albama.ProtocolType = c.ProtocolType;
                    ...
                    case "WVMCD":
                        using (WestVirginiaMedicaidEx wvmcd = new WestVirginiaMedicaidEx())
                        {
                            ...
                            wvmcd.ProtocolType = c.ProtocolType;
                            if (!_isTest)
                            { wvmcd.wsUrl = c.wsUrl; }
                            else
                    ...
                    case "CTMCD":
                        using (ConnecticutMedicaidEx ctmcd = new ConnecticutMedicaidEx())
                        {
                            ...
                            ctmcd.ProtocolType = c.ProtocolType;
                    ...
                    case "SCMCD_DCSWS":
                        using (SCMCDDCSWebService dcsscmcd = new SCMCDDCSWebService())
                        {
                            ...
                            dcsscmcd.ProtocolType = c.ProtocolType;
                    ...
                    case "SCMCD":
                        using (SouthCarolinaMedicaid scmcd = new SouthCarolinaMedicaid())
                        {
                            ...
                            scmcd.ProtocolType = c.ProtocolType;
                    ...
                    case "BCNC":
                        using (BCBSNorthCarolinaMedicaid bcnc = new BCBSNorthCarolinaMedicaid())
                        {
                            ...
                            bcnc.ProtocolType = c.ProtocolType;
                    ...
                    case "WAMCD":
                        using (WashingtonMedicaid wamcd = new WashingtonMedicaid())
                        {
                            ...
                            wamcd.ProtocolType = c.ProtocolType;
                    ...
                    case "MISSOULA":
                        using (MissoulaMedicaid missoula = new MissoulaMedicaid())
                        {
                            ...
                            missoula.ProtocolType = c.ProtocolType;
                    ...
                    case "NCMCD":
                        using (NorthCarolinaMedicaid ncmcd = new NorthCarolinaMedicaid())
                        {
                            ...
                            ncmcd.ProtocolType = c.ProtocolType;
                    ...
                    case "DEMCD":
                        using (DelawareMedicaid demcd = new DelawareMedicaid())
                        {
                            ...
                            demcd.ProtocolType = c.ProtocolType;
                    ...
                    case "BCAL":
                        using (BCBSAlbama bcal = new BCBSAlbama())
                        {
                            ...
                            bcal.ProtocolType = c.ProtocolType;
                    ...
                    case "ANTHEM":
                        using (Anthem antm = new Anthem())
                        {
                            ...
                            antm.ProtocolType = c.ProtocolType;
                    ...
                    case "BCTN":
                        using (TennesseeMedicaid bcbst = new TennesseeMedicaid())
                        {
                            ...
                            bcbst.ProtocolType = c.ProtocolType;
                    ...
                    case "BCDE":
                        using (HighMark hmark = new HighMark())
                        {
                            ...
                            hmark.ProtocolType = c.ProtocolType;
                    ...
                    case "MOMCD":
                        using (MissouriMedicaid momcd = new MissouriMedicaid())
                        {
                            ...
                            momcd.ProtocolType = c.ProtocolType;
                    ...
                    case "CENTENE":
                        using (Centene cent = new Centene())
                        {
                            ...
                            cent.ProtocolType = c.ProtocolType;
                    ...
                    case "HARVARD_DIRECT":
                        using (HarvardPilgrim harvard = new HarvardPilgrim())
                        {
                            ...
                            harvard.ProtocolType = c.ProtocolType;
                    ...
                    case "HARVARD":
                        using (HarvardPilgrimDCSWebService dcsharvard = new HarvardPilgrimDCSWebService())
                        {
                            ...
                            dcsharvard.ProtocolType = c.ProtocolType;
                    ...
                    case "BCRI":
                        using (BcRhodeIsland bcri = new BcRhodeIsland())
                        {
                            ...
                            bcri.ProtocolType = c.ProtocolType;
                    ...
                    case "BCWV":
                        using (BCWestVerginia bcwv = new BCWestVerginia())
                        {
                            ...
                            bcwv.ProtocolType = c.ProtocolType;
                    ...
                    case "BCWVDCS":
                        using (BCWestVerginiaDCSWebService bcwvdcs = new BCWestVerginiaDCSWebService())
                        {
                            ...
                            bcwvdcs.ProtocolType = c.ProtocolType;
                    ...
                    case "WELLMARK":
                        using (Wellmark wmc = new Wellmark())
                        {
                            ...
                            wmc.ProtocolType = c.ProtocolType;
                    ...
                    case "KYMCD":
                        using (KentuckyMedicaid kymcd = new KentuckyMedicaid())
                        {
                            ...
                            kymcd.ProtocolType = c.ProtocolType;
                    ...
                    case "BCNE":
                        using (BCNebraska bcnemcd = new BCNebraska())
                        {
                            ...
                            bcnemcd.ProtocolType = c.ProtocolType;
                    ...
                    case "BCPA":
                        using (PennsylvaniaMedicaid bcpa = new PennsylvaniaMedicaid())
                        {
                            ...
                            bcpa.ProtocolType = c.ProtocolType;
                    ...
                    case "FLMCD_DCS":
                        using (FloridaDCSWebService dcsflmcd = new FloridaDCSWebService())
                        {
                            ...
                            dcsflmcd.ProtocolType = c.ProtocolType;
                    ...
                    case "FLMCD":
                        using (FloridaMedicaid fmcd = new FloridaMedicaid())
                        {
                            ...
                            fmcd.ProtocolType = c.ProtocolType;
                    ...
                    case "OHMCD_DIRECT":
                        using (OhioMedicaid ohmcd = new OhioMedicaid())
                        {
                            ...
                            ohmcd.ProtocolType = c.ProtocolType;
                    ...
                    case "OHMCD":
                        using (OhioDCSWebService dcsohmcd = new OhioDCSWebService())
                        {
                            ...
                            dcsohmcd.ProtocolType = c.ProtocolType;
                    ...
                    case "NYMCD":
                        using (NewYorkMedicaid nymcd = new NewYorkMedicaid())
                        {
                            ...
                            nymcd.ProtocolType = c.ProtocolType;
                    ...
                    case "COMCD":
                        using (ColoradoMedicaid colorado = new ColoradoMedicaid())
                        {
                            ...
                            colorado.ProtocolType = c.ProtocolType;
                            if (!_isTest)
                            { colorado.wsUrl = c.wsUrl; }
                            else
                    ...
                    case "BCLA":
                        using (BCBSLouisiana bcbsla = new BCBSLouisiana())
                        {
                            ...
                            bcbsla.ProtocolType = c.ProtocolType;
                            if (!_isTest)
                            { bcbsla.wsUrl = c.wsUrl; }
                            else
                    ...
                    case "PAMCD":
                        using (PAMCD pamcd = new PAMCD())
                        {
                            ...
                            pamcd.ProtocolType = c.ProtocolType;
                            if (!_isTest)
                            { pamcd.wsUrl = c.wsUrl; }
                            else
                            ...
                            else
                            {
                                r = -1;
                                _OrigRES = pamcd.OrigRes;
                                log.ExceptionDetails("1165-DCSGlobal.EDI.Comunications.EDI.PAMCD.GetResponse Failed. Batch ID:" + Convert.ToString(_BatchID), "GetResponse Failed r =" + Convert.ToString(r));
                            }
                        }
                        break;
                    case "INMCD":
                        using (IndianaMedicaid india = new IndianaMedicaid())
                        {

                            india.VendorName = VendorName;
                            india.PayorCode = PayorCode;
                            india.ConnectionString = _ConnectionString;
                            india.wsUrl = c.wsUrl;
                            india.UserName = c.username;
                            india.Passwd = c.password;
                            india.REQ = RequestContent;
                            india.TaskID = _TaskID;
                            india.EBRID = _EBRID;
                            india.WaitTime = _WaitTime;
                            india.BHT03 = B_REQ;
                            india.VendorRetrys = _VendorRetrys;
                            india.PayloadType = c.PayloadType;
                            india.ProcessingMode = c.ProcessingMode;
                            india.PayloadID = B_REQ; //  c.PayloadID;
                            india.TimeStamp = c.TimeStamp;
                            india.SenderID = c.SenderID;
                            india.ReceiverID = c.ReceiverID;
                            india.CORERuleVersion = c.CORERuleVersion;
                            india.SendTimeout = c.ServiceTimeOut;
                            india.ReceiveTimeout = c.ReceiveTimeout;
                            india.VMetricsLogging = c.VMetricsLogging;
                            india.ProtocolType = c.ProtocolType;
                            if (!_isTest)
                            { india.wsUrl = c.wsUrl; }
                            else
                            { india.wsUrl = c.TestwsUrl; }

                            r = india.GetResponse();
                            if (r == 0)
                            {
                                _RES = india.RES;
                                _OrigRES = india.OrigRes;
                                doRESValidation = true;
                            }
                            else
                            {
                                r = -1;
                                _OrigRES = india.OrigRes;
                                log.ExceptionDetails("1165-DCSGlobal.EDI.Comunications.EDI.INDIANA.GetResponse Failed. Batch ID:" + Convert.ToString(_BatchID), "GetResponse Failed r =" + Convert.ToString(r));
                            }
                        }
                        break;

                    case "AZMCD":
                        using (ArizonaMedicaid azmcd = new ArizonaMedicaid())
                        {

                            azmcd.VendorName = VendorName;
                            azmcd.PayorCode = PayorCode;
                            azmcd.ConnectionString = _ConnectionString;
                            azmcd.wsUrl = c.wsUrl;
                            azmcd.UserName = c.username;
                            azmcd.Passwd = c.password;
                            azmcd.REQ = RequestContent;
                            azmcd.TaskID = _TaskID;
                            azmcd.EBRID = _EBRID;
                            azmcd.WaitTime = _WaitTime;
                            azmcd.BHT03 = B_REQ;
                            azmcd.VendorRetrys = _VendorRetrys;
                            azmcd.PayloadType = c.PayloadType;
                            azmcd.ProcessingMode = c.ProcessingMode;
                            azmcd.PayloadID = B_REQ; //  c.PayloadID;
                            azmcd.TimeStamp = c.TimeStamp;
                            azmcd.SenderID = c.SenderID;
                            azmcd.ReceiverID = c.ReceiverID;
                            azmcd.CORERuleVersion = c.CORERuleVersion;
                            azmcd.SendTimeout = c.ServiceTimeOut;
                            azmcd.ReceiveTimeout = c.ReceiveTimeout;
                            azmcd.VMetricsLogging = c.VMetricsLogging;
                            azmcd.ProtocolType = c.ProtocolType;
                            if (!_isTest)
                            { azmcd.wsUrl = c.wsUrl; }
                            else
                            { azmcd.wsUrl = c.TestwsUrl; }

                            r = azmcd.GetResponse();
                            if (r == 0)
                            {
                                _RES = azmcd.RES;
                                _OrigRES = azmcd.OrigRes;
                                doRESValidation = true;
                            }
                            else
                            {
                                r = -1;
                                _OrigRES = azmcd.OrigRes;
                                log.ExceptionDetails("1165-DCSGlobal.EDI.Comunications.EDI.AZMCD.GetResponse Failed. Batch ID:" + Convert.ToString(_BatchID), "GetResponse Failed r =" + Convert.ToString(r));
                            }
                        }
                        break;

                    case "BCAZ":
                        using (BCBSArizona bcbsaz = new BCBSArizona())
                        {

                            bcbsaz.VendorName = VendorName;
                            bcbsaz.PayorCode = PayorCode;
                            bcbsaz.ConnectionString = _ConnectionString;
                            bcbsaz.wsUrl = c.wsUrl;
                            bcbsaz.UserName = c.username;
                            bcbsaz.Passwd = c.password;
                            bcbsaz.REQ = RequestContent;
                            bcbsaz.TaskID = _TaskID;
                            bcbsaz.EBRID = _EBRID;
                            bcbsaz.WaitTime = _WaitTime;
                            bcbsaz.BHT03 = B_REQ;
                            bcbsaz.VendorRetrys = _VendorRetrys;
                            bcbsaz.PayloadType = c.PayloadType;
                            bcbsaz.ProcessingMode = c.ProcessingMode;
                            bcbsaz.PayloadID = B_REQ; //  c.PayloadID;
                            bcbsaz.TimeStamp = c.TimeStamp;
                            bcbsaz.SenderID = c.SenderID;
                            bcbsaz.ReceiverID = c.ReceiverID;
                            bcbsaz.CORERuleVersion = c.CORERuleVersion;
                            bcbsaz.SendTimeout = c.ServiceTimeOut;
                            bcbsaz.ReceiveTimeout = c.ReceiveTimeout;
                            bcbsaz.VMetricsLogging = c.VMetricsLogging;
                            bcbsaz.ProtocolType = c.ProtocolType;
                            if (!_isTest)
                            { bcbsaz.wsUrl = c.wsUrl; }
                            else
                            { bcbsaz.wsUrl = c.TestwsUrl; }

                            r = bcbsaz.GetResponse();
                            if (r == 0)
                            {
                                _RES = bcbsaz.RES;
                                _OrigRES = bcbsaz.OrigRes;
                                doRESValidation = true;
                            }
                            else
                            {
                                r = -1;
                                _OrigRES = bcbsaz.OrigRes;
                                log.ExceptionDetails("1165-DCSGlobal.EDI.Comunications.EDI.BCBSAZ.GetResponse Failed. Batch ID:" + Convert.ToString(_BatchID), "GetResponse Failed r =" + Convert.ToString(r));
                            }
                        }
                        break;

                    case "MONTSUB":
                        using (MontanaBatchSubmitTransaction montsub = new MontanaBatchSubmitTransaction())
                        {

                            montsub.VendorName = VendorName;
                            montsub.PayorCode = PayorCode;
                            montsub.ConnectionString = _ConnectionString;
                            montsub.wsUrl = c.wsUrl;
                            montsub.UserName = c.username;
                            montsub.Passwd = c.password;
                            montsub.REQ = RequestContent;
                            montsub.TaskID = _TaskID;
                            montsub.EBRID = _EBRID;
                            montsub.WaitTime = _WaitTime;
                            montsub.BHT03 = B_REQ;
                            montsub.VendorRetrys = _VendorRetrys;
                            montsub.PayloadType = c.PayloadType;
                            montsub.ProcessingMode = c.ProcessingMode;
                            montsub.PayloadID = B_REQ; //  c.PayloadID;
                            montsub.TimeStamp = c.TimeStamp;
                            montsub.SenderID = c.SenderID;
                            montsub.ReceiverID = c.ReceiverID;
                            montsub.CORERuleVersion = c.CORERuleVersion;
                            montsub.SendTimeout = c.ServiceTimeOut;
                            montsub.ReceiveTimeout = c.ReceiveTimeout;
                            montsub.VMetricsLogging = c.VMetricsLogging;
                            montsub.ProtocolType = c.ProtocolType;
                            if (!_isTest)
                            { montsub.wsUrl = c.wsUrl; }
                            else
                            { montsub.wsUrl = c.TestwsUrl; }

                            r = montsub.GetResponse();
                            if (r == 0)
                            {
                                _RES = montsub.RES;
                                _OrigRES = montsub.OrigRes;
                                doRESValidation = true;
                            }
                            else
                            {
                        ...
                        break;
                    case "MONTRET":
                        using (MontanaBatchRetrievalTransaction montret = new MontanaBatchRetrievalTransaction())
                        {

                            montret.VendorName = VendorName;
                            montret.PayorCode = PayorCode;
                            montret.ConnectionString = _ConnectionString;
                            montret.wsUrl = c.wsUrl;
                            montret.UserName = c.username;
                            montret.Passwd = c.password;
                            montret.REQ = RequestContent;
                            montret.TaskID = _TaskID;
                            montret.EBRID = _EBRID;
                            montret.WaitTime = _WaitTime;
                            montret.BHT03 = B_REQ;
                            montret.VendorRetrys = _VendorRetrys;
                            montret.PayloadType = c.PayloadType;
                            montret.ProcessingMode = c.ProcessingMode;
                            montret.PayloadID = B_REQ; //  c.PayloadID;
                            montret.TimeStamp = c.TimeStamp;
                            montret.SenderID = c.SenderID;
                            montret.ReceiverID = c.ReceiverID;
                            montret.CORERuleVersion = c.CORERuleVersion;
                            montret.SendTimeout = c.ServiceTimeOut;
                            montret.ReceiveTimeout = c.ReceiveTimeout;
                            montret.VMetricsLogging = c.VMetricsLogging;
                            montret.ProtocolType = c.ProtocolType;
                            if (!_isTest)
                            { montret.wsUrl = c.wsUrl; }
                            else
                            { montret.wsUrl = c.TestwsUrl; }

                            r = montret.GetResponse();
                            if (r == 0)
                            {
                                _RES = montret.RES;
                                _OrigRES = montret.OrigRes;
                                doRESValidation = true;
                            }
                            else
                            {
