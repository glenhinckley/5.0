...
{
    class MaineMedicaidEx : IDisposable
    {
        //  private NoResponse NoResp = new NoResponse();
        ...
        private int GoToVendor()
        {
            ...
            catch (Exception ex)
            {
                ...
                MLOG_ID = log.MLOG(_VendorName, ex.Message, _EBRID, stime, rtime, B_RES, B_REQ, PayloadIDTX, PayloadIDRX, sPayload, _REQ);
