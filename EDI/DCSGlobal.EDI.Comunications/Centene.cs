    ...
    class Centene : IDisposable
    {
        ...
        public int GoToVendor()
        {
            ...
            catch (Exception ex)
            {
                ...
                log.ExceptionDetails("CENTENE GetResponse Failed Total Elasped ticks" + Convert.ToString(_elapsedTicks) + " | EBR ID:" + _EBRID  + " | Service time out  | " + _ServiceTimeOut + " | " + _VendorName + "|" + _PayorCode + "|" + _wsUrl + "|" + _REQ, ex);
            }
            return r;
        }
